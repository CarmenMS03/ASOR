# 🖥️ ASOR - Ampliación de Sistemas Operativos y Redes (UCM)

Este repositorio contiene todas las prácticas realizadas durante la asignatura de **Ampliación de Sistemas Operativos y Redes (ASOR)**, correspondiente al Grado en Ingeniería Informática de la **Universidad Complutense de Madrid**.

## 📝 Descripción
El objetivo de esta asignatura es aprender a instalar, configurar y administrar sistemas operativos de servidor (como Windows Server y distribuciones de Linux), así como gestionar servicios de red, usuarios, permisos y seguridad. Además, se estudian conceptos avanzados de redes como IPv4, IPv6, protocolos de Internet y administración de servicios.
